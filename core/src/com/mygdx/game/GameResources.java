...
public class GameResources {
    ...
    public static  String TRASH_IMG_PATH = "textures/trash.png";
    public static final String PINE_IMG_PATH = "textures/pineapple.png";
    public static final String TRASH_IMG_PATH2 = "textures/trash2.png";

    public static final String HEALTH_IMG_PATH = "textures/health.png";
    ...
    public static final String FONT_PATH = "fonts.ttf";
